...
while True:
    ...
    if command == 1:
        ...
        edit_flash = FlashcardManager()
        edit_flash.edit_flashcard(old_question, new_question, new_answer)

    elif command == 3:
        delete_question = input("What question do you want to delete: ")
        delete_flashcard = FlashcardManager()
        delete_flashcard.delete_flashcard(delete_question)
